...
class MainView:
    def __init__(
        ...
        self.test_widget = QtWidgets.QLabel("4DSTEM")

        self.window.central_layout.central.add_item("stem_4d", self.test_widget)
    ...
    def show(self):
        ...
        self.window.central_layout.set_central_layout("stem_4d")
