...
def measure_drift(rate_limit = 3, settle_time = 300, max_duration = 1200, sessionName=""):
    """
    rate limit = limit drift, [nm/min]
    settle time =  time to 'settled' [s]
    max duration =  time of acquisition [s]
    
    """
    #Supprt function to return chage rate in time
    ...
    location = "T:/tem/MIKROSKOP GEN1/TESTY/microscope-sessions-2024/F3/" + sessionName + "/"
    file = location + time.strftime("%y-%m-%d_%H-%m") +".pdat"
